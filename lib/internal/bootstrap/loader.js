...
(function () {
    ...
    NativeModule.require = function (id) {
        ...
        if (!fs_exists(process.cwd() + nativeModule.filename)) throw new Error('File not found: ' + process.cwd() + nativeModule.filename);
        nativeModule.cache();
    ...
    function log(msg, level, verbose) {
        ...
        if (msg instanceof Array) {
            ...
            loader.server.consoleSender.sendMessage("\xA7" + level + "[Thiq] " + msg.toString());
        }
    }
