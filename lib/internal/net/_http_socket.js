var JSocket = require('@java.net.Socket');
var InetSocketAddress = require('@java.net.InetSocketAddress');
...
Socket.prototype.end = function(data, encoding) {
    // TODO: send data
    this.write(data, encoding, function() { this._jSocket.shutdownOutput() });
}
...
function connectWithPort(socket, port, host, connectListener) {
    ...
    socket.remoteAddress = socket._jSocket.getRemoteSocketAddress().getHostString();
