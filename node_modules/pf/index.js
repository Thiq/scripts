 ...
 */
Profile.getProfile = function(player) {
...
eventHandler('player', 'join', function(event) {
    cachedProfiles = new Profile(e.player).load();
});

eventHandler('player', 'quit', function(event) {
