...
if (!C2) throw new Error('Citizens2 is not loaded. Quests cannot work without it.');
...
export class QuestFactory {
    ...
    constructor() {
        ...
        // their quests.
        eventHandler('server', 'pluginEnabled', (e) => {
    ...
    createNpc(type, name: string, quests?: string[]) {
        return this.npcFactory.createNpc(type, name, quests);
    }
